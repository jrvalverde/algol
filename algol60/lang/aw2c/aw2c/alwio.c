/* GENERATED BY scanner_state_machine.py: DON'T EDIT THIS FILE, EDIT alwio.c.input */
#line 2 "alwio.c.input"
...
Scanner_scan (alw_Scanner *scanner)
{
  ...
  while (true) {
    ...
    case 605:
      ...
      break;
#line 201 "alwio.c.input"
    /* See scanner_state_machine.py */
    }
  }
}
