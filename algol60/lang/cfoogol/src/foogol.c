/*---------------------------------------------------------------------*\
!                                                                       !
!  fc.c  Compiler for FOOGOL IV -- version 5.0  Last change:1994-01-12  !
!        Translates FOOGOL IV into stupid but portable C                !
!                                                                       !
!    Written by Per Lindberg, QZ, Box 27322, 10254 Stockholm, Sweden.   !
!    C code generation by John Cowan <cowan@snark.thyrsus.com>          !
!                                                                       !
