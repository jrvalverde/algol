...
struct dsa_iabs_0
{     /* procedure iabs (level 0) declared at line 26 */
      char *proc;
      char *file;
      int line;
      struct dsa *parent;
...
{     struct dsa_iabs_0 my_dsa;
      ...
      my_dsa.line = 28;
      my_dsa.E_1 = get_int((global_dsa = E_1.arg2, (*(struct desc (*)(
         void))E_1.arg1)()));
      ...
      dsa_0->line = 29;
      dsa_0->retval.u.int_val = ((notless(dsa_0->E_1, 0)) ? (dsa_0->E_1)
          : (-dsa_0->E_1));
