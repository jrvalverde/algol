...
{     /* procedure outreal (level 0) declared at line 26 */
      char *proc;
      char *file;
      int line;
      struct dsa *parent;
...
{     struct dsa_outreal_0 my_dsa;
      ...
      my_dsa.line = 29;
      my_dsa.re_1 = get_real((global_dsa = re_1.arg2, (*(struct desc (*)
         (void))re_1.arg1)()));
      ...
      dsa_0->line = 30;
      /* inline code */
      outreal(my_dsa.channel_1, my_dsa.re_1);
