...
extern struct desc ln_0 /* builtin real procedure */
(     struct arg /* E: by value real */
);

extern struct desc maxreal_0 /* builtin real procedure */ (void);
...
struct dsa_exp_0
{     /* procedure exp (level 0) declared at line 26 */
      char *proc;
      char *file;
      int line;
      struct dsa *parent;
...
{     struct dsa_exp_0 my_dsa;
      ...
      dsa_0->line = 29;
      if (!(greater(dsa_0->E_1, get_real((global_dsa = (void *)dsa_0, 
         ln_0(make_arg((void *)maxreal_0, dsa_0))))))) goto _gamma_1;
      dsa_0->line = 30;
...
_gamma_1:
      dsa_0->line = 32;
      /* inline code */
      my_dsa.retval.u.real_val = exp(my_dsa.E_1);
_omega_1:
